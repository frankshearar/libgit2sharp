...
namespace LibGit2Sharp
{
    ...
    public abstract class OdbBackend
    {
        ...
        protected unsafe UnmanagedMemoryStream Allocate(long size)
        {
            ...
            IntPtr buffer = Proxy.Std.git_odb_backend_malloc(this.GitOdbBackendPointer, new UIntPtr((ulong)size));
        ...
        private static class BackendEntryPoints
        {
            ...
            private static OdbBackend MarshalOdbBackend(IntPtr backendPtr)
            {
                ...
                if (odbBackend == null)
                {
                    Proxy.Std.giterr_set_str(GitErrorCategory.Reference, "Cannot retrieve the managed OdbBackend.");
                    return null;
                }
